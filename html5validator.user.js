...
var HTML5Vlidator = {
    ...
    init: function() {
        ...
        self.icon_img.setAttribute('style', [
            'position: fixed',
            'bottom:   10px',
            'left:     10px',
            'z-index:  10000000',
    ...
    on_load_validate: function(res) {
        ...
        if (data.messages.length) {
            self.icon_img.src = self.images.invalid;
            self._create_error_console(data.messages);
        }
        else {
    ...
    _create_error_console: function(messages) {
        var self = HTML5Vlidator;
        ...
        var close_btn_id = 'GM_html5validator_close_btn';
